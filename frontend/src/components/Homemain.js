        ...
        <div className='disflex' style={{
            ...
            <div className='w100'>
                ...
                <div style={{ display: "flex", flexFlow: isMobile ? "row" : "column", justifyContent: isMobile ? "center" : "start", marginTop: ".7em" }}>
                    <Link to={localStorage.getItem('token') ? "/LetsChat" : "/login"} className='lbtn disflex' style={{ backgroundColor: appcolor, width:isMobile?"60%":"40%", fontSize: isMobile ? "1.1rem" : istablet ? "1rem" : "1.2rem" }}>Chat with friends</Link>
                </div>
            </div>
